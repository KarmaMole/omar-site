...
const skills = [
  { category: "AI", items: ["ChatGPT", "Claude", "MidJourney", "Gemini", "Kling", "Veo"] },
          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 items-start gap-12 mb-20">
              <div className="md:col-span-2">
                {settings.aboutBio ? (
                  <div className="prose prose-invert prose-sm prose-p:text-light-300 prose-p:leading-relaxed max-w-none [&>*:first-child]:mt-0">
