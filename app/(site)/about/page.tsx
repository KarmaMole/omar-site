          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 items-start gap-12 mb-20">
              <div className="md:col-span-2">
                {settings.aboutBio ? (
                  <div className="prose prose-invert prose-p:text-light-300 prose-p:leading-relaxed prose-p:text-[13.5px] max-w-none prose-p:first:mt-0 [&_p:first-of-type]:!mt-0">
