        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mt-10">
            {[
              ...
              { name: "Iran War Monitor", url: "https://war-monitor.replit.app/", domain: "war-monitor.replit.app", description: "Real-time monitoring dashboard tracking military and geopolitical developments across the Iran region with live data feeds.", tags: ["Geopolitics", "Real-time", "Dashboard", "Data"] },
              ...
              { name: "Optix Projects", url: "https://optixprojects.replit.app/", domain: "optixprojects.replit.app", description: "Project management and tracking platform built for the Optix creative production pipeline and cross-team coordination.", tags: ["Projects", "Management", "Production", "Workflow"] },
            ].map((t, i) => (
